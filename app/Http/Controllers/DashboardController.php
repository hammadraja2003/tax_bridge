...
class DashboardController extends Controller
{
    ...
    //     $fbrPostedInvoices = DB::table('invoices')->where('is_posted_to_fbr', 1)->count();
    ...
    //     $draftInvoices = DB::table('invoices')->where('invoice_status', 1)->count();
    ...
    public function index()
    {
        ...
        // $fbrUnpostedPercentage = $totalInvoices > 0
        //     ? round((($totalInvoices - $fbrPostedInvoices) / $totalInvoices) * 100, 2)
        //     : 0;
