      ...
      <div class="card-body">
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="name" required class="form-control @error('title', 'post') is-invalid @enderror"
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="email" required class="form-control @error('title', 'post') is-invalid @enderror"
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            ...
            <small class="text-danger ms-2">Note: (Min 8 characters, 1 uppercase, 1 lowercase, 1 number, 1 special
              character)</small>
