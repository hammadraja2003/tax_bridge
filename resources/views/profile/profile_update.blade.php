...
<div class="container">
  ...
  @endphp
  <form class="app-form needs-validation" id="updateProfileForm" novalidate method="POST" action="{{ route('update-profile', $encryptedId) }}" enctype="multipart/form-data">
    @csrf
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            ...
            <small class="text-danger ms-2">Note: (Min 8 characters, 1 uppercase, 1 lowercase, 1 number, 1 special character)</small>
        ...
        <!-- Optional Profile Image Section (Uncomment if needed) -->
        <!--
        <div class="row mb-3">
          <div class="col-md-6">
