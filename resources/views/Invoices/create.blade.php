...
<div class="container">
          ...
          <div class="card-body row g-3">
            ...
            <div class="col-md-6">
              ...
              <input
                ...
                class="form-control"
                value="SECUREISM (PRIVATE) LIMITED"
                required
              />
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <textarea name="sellerAddress" class="form-control" required>
            Innovation & Incubation Floor-3rd F3 Centre of Information & Cyber Security Sector B Zaraj Housing Scheme Islamabad</textarea
              >
            </div>
          </div>
        </div>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body row g-3">
            ...
            <div class="col-md-6">
              ...
              <textarea name="buyerAddress" class="form-control">
                Office No 3, Mezzanine Floor, Rehman Plaza, Plot No. 75-East, Fazal-e-Haq Road, Blue Area, Islamabad</textarea
              >
            </div>
            <div class="col-md-6">
    ...
    <template id="itemTemplate">
      <div class="item-group border rounded p-3 mb-4 position-relative">
        <button type="button" class="btn-close position-absolute end-0 top-0" onclick="removeItem(this)"></button>
        <div class="row g-3">
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <input
              type="text"
              name="items[][productDescription]"
              class="form-control"
              value="API Integration Services"
              required
            />
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-3">
            ...
            <input
              ...
              name="items[][saleType]"
              class="form-control"
              placeholder="e.g. Goods at standard rate"
              required
            />
          </div>
          <div class="col-md-3">
