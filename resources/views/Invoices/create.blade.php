    ...
    <div class="card-body row g-3">
      <div class="col-md-12">
        <div class="alert alert-info py-2">
          <strong>Note:</strong> If <em>Buyer Registration Type</em> is <strong>Unregistered</strong>, then all fields
    ...
    <div class="row g-3">
      ...
      <div class="col-md-4">
        <label class="form-label required">Total Value Including Tax <i class="bi bi-info-circle"
            data-bs-toggle="tooltip"
            title="Total value **including tax**. 18% tax on Rs. 2000 = 360, so total = 2000 + 360 = 2360"></i> </label>
