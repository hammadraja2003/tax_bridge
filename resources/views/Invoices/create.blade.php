                    ...
                    <div class="col-md-3">
                        ...
                        <select name="invoiceType" id="invoiceType" class="form-select" required>
                            ...
                            <option value="Sale Invoice"
                                {{ $isEdit && $invoice->invoice_type === 'Sale Invoice' ? 'selected' : '' }}>Sales Invoice
                            </option>
                            <option value="Debit Note"
                                {{ $isEdit && $invoice->invoice_type === 'Debit Note' ? 'selected' : '' }}>Debit
                                Note</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="card-body row g-3">
                    <div class="col-md-12">
                        <div class="alert alert-info py-2">
                            <strong>Note:</strong> If <em>Client Registration Type</em> is <strong>Unregistered</strong>,
                            then all
                            fields
                        ...
                        <select id="byr_id" class="form-select" name="byr_id">
                            ...
                            @foreach ($buyers as $b)
                                <option value="{{ $b->byr_id }}"
                                    {{ $isEdit && $invoice->buyer_id == $b->byr_id ? 'selected' : '' }}>
                                    {{ $b->byr_name }}
                                </option>
                            @endforeach
                        </select>
    ...
    <template id="itemTemplate">
        <div class="item-group border rounded p-3 mb-4 position-relative">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <label class="form-label">SRO Schedule No (Optional) <i class="bi bi-info-circle"
                            data-bs-toggle="tooltip"
                ...
                <div class="col-md-4">
                    <label class="form-label">SRO Item Serial No (Optional) <i class="bi bi-info-circle"
                            data-bs-toggle="tooltip"
