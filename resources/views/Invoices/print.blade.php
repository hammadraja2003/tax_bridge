...
<body>
  ...
  <div class="container" id="invoiceArea">
    ...
    <div class="top-row">
      ...
      <div class="top-section">
        <p><strong>Invoice Date:</strong><br>{{ \Carbon\Carbon::parse($invoice->invoice_date)->format('d M Y')
          }}<br><br>
    ...
    <div class="footer" style="text-align: justify;">
      Company Registration No: 0119999 | Registered Office: SECUREISM (PRIVATE) LIMITED, Innovation & Incubation, 3rd
      Floor, F3, Centre of Information & Cyber Security, Sector B, Zaraj Housing Scheme, Islamabad, 46000, Pakistan.
    </div>
  </div>