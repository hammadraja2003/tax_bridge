        ...
        <div class="card mb-4">
            <div class="card-body row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="byr_name" placeholder="Enter a Client Name" class="form-control"
                        required />
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="byr_ntn_cnic" placeholder="Enter a NTN/CNIC" class="form-control"
                        required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="byr_acc_branch_name" placeholder="Enter a Branch Name" class="form-control"
                        required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="byr_account_title" placeholder="Enter a Account Title" class="form-control"
                        required />
                    <div class="invalid-feedback">
