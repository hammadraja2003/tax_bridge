        ...
        <div class="card mb-4">
            <div class="card-body row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="byr_name" placeholder="Enter a Client Name" value="{{ $buyer->byr_name }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="byr_ntn_cnic" placeholder="Enter a NTN/CNIC"
                        value="{{ $buyer->byr_ntn_cnic }}" class="form-control" required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="byr_reg_num" placeholder="Enter a Registration Number" class="form-control"
                        value="{{ $buyer->byr_reg_num }}" required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="byr_contact_num" placeholder="Enter a Contact Number" class="form-control"
                        value="{{ $buyer->byr_contact_num }}" required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="byr_contact_person" placeholder="Enter a Contact Person"
                        value="{{ $buyer->byr_contact_person }}" class="form-control" required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="byr_province" class="form-control" placeholder="Enter Province"
                        value="{{ $buyer->byr_province ?? old('byr_province') }}" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="byr_address" class="form-control" placeholder="Enter a Address"
                        required>{{ $buyer->byr_address }}</textarea>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="byr_acc_branch_name" placeholder="Enter a Branch Name"
                        value="{{ $buyer->byr_acc_branch_name }}" class="form-control" required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="byr_acc_branch_code" placeholder="Enter a Branch Code"
                        value="{{ $buyer->byr_acc_branch_code  }}" class="form-control" required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="byr_account_title" placeholder="Enter a Account Number"
                        value="{{ $buyer->byr_account_title }}" class="form-control" required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="byr_account_number" placeholder="Enter a Account Title"
                        value="{{ $buyer->byr_account_number }}" class="form-control" required />
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="byr_swift_code" placeholder="Enter a SWIFT Code"
                        value="{{ $buyer->byr_swift_code }}" class="form-control" />
                </div>
