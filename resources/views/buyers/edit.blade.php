    ...
    <div class="container-fluid">
                ...
                <div class="card-body row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="byr_ntn_cnic" id="byr_ntn_cnic" placeholder="Enter a NTN/CNIC"
                            value="{{ old('byr_ntn_cnic', $buyer->byr_ntn_cnic) }}" class="form-control" />
        ...
        <option value="Azad Jammu and Kashmir" {{ old('byr_province', $buyer->byr_province) == 'Azad Jammu and Kashmir' ? 'selected' : '' }}>Azad Jammu and Kashmir</option> --}}
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="byr_address" class="form-control" placeholder="Enter a Address" required>{{ old('byr_address', $buyer->byr_address) }}</textarea>
