                ...
                <div class="mb-4 p-4 border rounded shadow-sm text-white" style="background-color: #1d9797;">
                    <form method="GET" action="{{ route('buyers.index') }}" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="search" id="search" class="form-control bg-white text-dark"
                        ...
                        <div class="col-12 d-flex justify-content-end gap-2">
                            ...
                            <a href="{{ route('buyers.index') }}" class="btn btn-secondary">Clear</a>
                            @endif
                        </div>
                    </form>
                </div>
                    ...
                    <div class="card-body p-0">
                        <div id="myTable">
                            <div class="list-table-header d-flex justify-content-sm-between">
                                <a href="{{ route('buyer.create') }}" class="btn btn-primary"><i
                                        class="fa-solid fa-plus fa-fw"></i>Add New Client</a>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img src="{{ asset('uploads/buyer_images/' . $buyer->byr_logo) }}"
                                                    alt="Logo" width="50" style="max-width: 200px;">
                                            ...
                                            <td style="white-space: normal; max-width: 200px;">{{ $buyer->byr_address }}
                                            </td>
                                            <td>
                                                <a href="{{ route('buyers.edit', Crypt::encryptString($buyer->byr_id)) }}"
                                                    class="btn btn-xs btn-outline-success"><i
                                                        class="ti ti-edit f-s-20 text-success"></i></a>
