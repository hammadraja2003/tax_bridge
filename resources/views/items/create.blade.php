            ...
            <div class="card mb-4">
                <div class="card-body row g-3">
                    <div class="col-md-6">
                        ...
                        <textarea name="item_description" class="form-control" placeholder="Enter a Item Description" required>{{ old('item_description') }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="item_hs_code" value="{{ old('item_hs_code') }}"
                            placeholder="Enter a HS Code" class="form-control" required />
                        @error('item_hs_code')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" name="item_price" value="{{ old('item_price') }}"
                            placeholder="Enter a Price" class="form-control" required />
                        @error('item_price')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input name="item_tax_rate" value="{{ old('item_tax_rate') }}" class="form-control"
                            placeholder="Enter a Tax Rate" required />
                        @error('item_tax_rate')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" name="item_uom" value="{{ old('item_uom') }}" class="form-control"
                            placeholder="Enter a Unit of Measure" required />
                        @error('item_uom')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
