                ...
                <div class="card-body row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="bus_ntn_cnic" id="bus_ntn_cnic" placeholder="Enter a NTN / CNIC"
                            class="form-control" required value="{{ old('bus_ntn_cnic', $config->bus_ntn_cnic ?? '') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="bus_reg_num" placeholder="Enter a Registration #" class="form-control"
                            required value="{{ old('bus_reg_num', $config->bus_reg_num ?? '') }}">
