      ...
      <div class="card-body">
        <div class="row mb-3">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="bus_reg_num" placeholder="Enter a Registration #" class="form-control" required value="{{ old('bus_reg_num', $config->bus_reg_num ?? '') }}">
            <div class="invalid-feedback">Please Enter Business NTN/CNIC.</div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-3">
            ...
            <input type="text" name="bus_account_title" class="form-control"  placeholder="Enter a Account Title" value="{{ old('bus_account_title', $config->bus_account_title ?? '') }}" required>
            <div class="invalid-feedback">
