      ...
      <div class="card-body">
        <div class="row mb-3">
          <div class="col-md-4">
            ...
            <input type="text" name="bus_name" placeholder="Enter a Buissness Name" class="form-control" required
              value="{{ old('bus_name', $config->bus_name ?? '') }}">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="bus_ntn_cnic" placeholder="Enter a NTN / CNIC" class="form-control" required
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="bus_reg_num" placeholder="Enter a Registration #" class="form-control" required
              value="{{ old('bus_reg_num', $config->bus_reg_num ?? '') }}">
            <div class="invalid-feedback">Please Enter Business NTN/CNIC.</div>
            @error('bus_reg_num') <div class="invalid-feedback">{{ $message }}</div> @enderror
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div class="col-md-4">
            ...
            <input type="text" name="bus_contact_num" placeholder="Enter a Contact Number" class="form-control"
              value="{{ old('bus_contact_num', $config->bus_contact_num ?? '') }}" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="bus_contact_person" class="form-control" placeholder="Enter a Contact Person"
        ...
        <div class="mb-3">
          ...
          <textarea name="bus_address" class="form-control" placeholder="Enter a Addres"
            required>{{ old('bus_address', $config->bus_address ?? '') }}</textarea>
          <div class="invalid-feedback">
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <input type="text" name="bus_acc_branch_name" placeholder="Enter a Branch Name" class="form-control"
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="bus_acc_branch_code" placeholder="Enter a Branch Code" class="form-control"
        ...
        <div class="row mb-3">
          <div class="col-md-3">
            ...
            <input type="text" name="bus_account_number" class="form-control" placeholder="Enter a Account Number"
          ...
          <div class="col-md-3">
            ...
            <input type="text" name="bus_account_title" class="form-control" placeholder="Enter a Account Title"
          ...
          <div class="col-md-3">
            ...
            <input type="text" name="bus_swift_code" placeholder="Enter a SWIFT Code" class="form-control"
              value="{{ old('bus_swift_code', $config->bus_swift_code ?? '') }}">
          </div>
        </div>
