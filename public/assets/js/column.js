...
colors: ['#FAC10F','#3C91F3','#ACB8C8','#231928'],
  };
...
var options = {
  ...
  legend: {
    ...
    markers: {
      fillColors: ['#FAC10F','#3C91F3']
    }
  },
 
colors: ['#FAC10F','#3C91F3'],
  };
...
Apex = {
  ...
  var colors = [getLocalStorageItem('color-primary','#056464'), getLocalStorageItem('color-secondary','#74788D'), '#06b38b', '#eb565a', '#fbc05b', '#29b0f2', '#e8eaf2'];
...
colors: [getLocalStorageItem('color-primary','#056464'), getLocalStorageItem('color-secondary','#74788D'), '#06b38b', '#eb565a', '#fbc05b', '#29b0f2', '#e8eaf2'],
  xaxis: {
    categories: [
      'John Doe',
      'Joe Smith',
